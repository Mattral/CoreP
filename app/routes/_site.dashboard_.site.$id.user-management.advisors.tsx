...
export default function DashboardDomain() {
  ...
  return (
    <>
      <DashboardHeader title={'Advisors'} setOpenDrawer={setOpenDrawer} />

      <section className="row my-4">
        <h4>Unverified Advisors</h4>
        <table className="table table-hover table-striped">
          <caption>List of Unverified Advisors</caption>
          <thead>
            <tr>
              <th>S/N</th>
              <th>Name</th>
            ...
            {unverifiedData.map((item, index) => {
              return (
                <tr key={index}>
                  ...
                  <td>
                    <button className="btn btn-primary me-3 mb-2 mb-lg-0">
                      Edit
                    </button>
      ...
      <section className="row my-4">
        ...
        <table className="table table-hover table-striped">
          <caption>List of Verified Advisors</caption>
          <thead>
            <tr>
              <th>S/N</th>
              <th>Name</th>
